...
Soy un desarrollador apasionado por crear aplicaciones web y móviles innovadoras. Me especializo en el desarrollo full stack, desde el diseño de interfaces hasta la implementación de arquitecturas robustas en el backend.

### 💼 ¿Qué hago?
- 🌐 **Desarrollo Web**: Aplicaciones web modernas y responsivas
- 📱 **Desarrollo Móvil**: Apps nativas y multiplataforma
- 🎨 **UI/UX Design**: Diseño de interfaces intuitivas y atractivas
- ⚙️ **Backend Development**: APIs RESTful y microservicios
- 🗄️ **Base de Datos**: Diseño y optimización de bases de datos
...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=villegas07&color=blueviolet&style=flat-square&label=Profile+Views" alt="Profile views" />
</div>
